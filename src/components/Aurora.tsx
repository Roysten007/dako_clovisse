...
export default function Aurora(props: { colorStops?: string[], amplitude?: number, blend?: number, time?: number, speed?: number }) {
  const { colorStops = ['#FFB400', '#FFD700', '#FFB400'], amplitude = 1.0, blend = 0.5 } = props;
